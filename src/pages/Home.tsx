...
const Home = () => {
  return (
    <div className="h-[calc(80vh-4rem)] text-center items-center flex flex-col justify-center-safe ">
        <h4 className="great-vibes-regular text-9xl">James Idris</h4>
        <hr className="border-gray-300 my-2 w-2xs" />
        <p className="montserrat-regular text-md text-gray-600">Full Stack Software Developer</p>
        <hr className="border-gray-300 my-2 w-2xs" />
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          ...
          <p className="border-2 text border-gray-300 rounded-md p-3 special-gothic-expanded-one-regular text-center">Express.js</p>
